...
export class IncidentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('championApp.incident.delete.question'));
...
export default class IncidentComponentsPage {
  ...
  async deleteIncident() {
    ...
    expect(await incidentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/championApp.incident.delete.question/);
